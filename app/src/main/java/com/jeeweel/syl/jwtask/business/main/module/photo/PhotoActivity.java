...
public class PhotoActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MyPageAdapter(listViews);// 鏋勯�adapter
    ...
    private void initListViews(Bitmap bm) {
        ...
        ImageView img = new ImageView(this);// 鏋勯�textView瀵硅薄
    ...
    private OnPageChangeListener pageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageScrolled(int arg0, float arg1, int arg2) {// 婊戝姩涓�銆傘�

        }

        public void onPageScrollStateChanged(int arg0) {// 婊戝姩鐘舵�鏀瑰彉
    ...
    class MyPageAdapter extends PagerAdapter {
        ...
        public MyPageAdapter(ArrayList<View> listViews) {// 鏋勯�鍑芥暟
            // 鍒濆鍖杤iewpager鐨勬椂鍊欑粰鐨勪竴涓〉闈�
            this.listViews = listViews;
            size = listViews == null ? 0 : listViews.size();
        }

        public void setListViews(ArrayList<View> listViews) {// 鑷繁鍐欑殑涓�釜鏂规硶鐢ㄦ潵娣诲姞鏁版嵁
            this.listViews = listViews;
            size = listViews == null ? 0 : listViews.size();
        }
        ...
        public void destroyItem(View arg0, int arg1, Object arg2) {// 閿�瘉view瀵硅薄
